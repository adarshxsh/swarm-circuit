...
import { Play, Square, Settings, Layout, Code2, Clock, Terminal, FastForward, Pause, Plus, MonitorPlay, Activity, Loader2 } from 'lucide-react';
...
export default function Workspace() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg-primary)', overflow: 'hidden' }}>
      ...
      {/* TOOLBAR */}
      <div style={{ height: '70px', flexShrink: 0, borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', padding: '0 24px', paddingLeft: isJudgeMode ? '24px' : '60px', justifyContent: 'space-between', background: 'var(--bg-secondary)' }}>
